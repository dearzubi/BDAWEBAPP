...
module.exports = async function (context, req) {
    ...
    try {
        ...
        let top = (req.query.top || (req.body && req.body.top));
        let skip = (req.query.skip || (req.body && req.body.skip));
        let filters = (req.query.filters || (req.body && req.body.filters));
        let select = (req.query.select || (req.body && req.body.select));
        let facets = readFacets(process.env["SearchFacets"]);
